    ...
    <div class="panel panel-default panel-primary">
      ...
      <div class="panel-body">
        <form class="form-signin" role="form" action="action/Action_login.php" method="post">
          ...
          <div  id="login_error_alert_div" class="alert alert-danger alert-dismissible fade in" role="alert">
            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
            <strong>로그인 실패</strong><br><br><?=(isset($_SESSION["login_error_msg"]) ? $_SESSION["login_error_msg"] :"" )?>
          </div>

          <div style="padding:10px;"></div>
          <button class="btn btn-lg btn-primary btn-block" type="submit">로그인</button>
         
          <input type="hidden" id="login_error_msg" value= '<?=(isset($_SESSION["login_error_msg"]) ? $_SESSION["login_error_msg"] :"" )?>'/>
        </form>
      </div>
    </div>
