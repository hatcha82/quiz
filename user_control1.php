                ...
                <div class="col-md-1">
                    ...
                    <div class="thumbnail"> 
                        ...
                        <div class="caption">
                            ...
                            <p style="float:left;width:50%">포기 가능: <span id="user_quiz_giveup_display"></span></p>    
                            <p style="float:right;width:50%"><span style="float:right">남은 포기횟수: <span id="user_quiz_giveup_count_display"></span></span></p>
...
<script>
    ...
    function current_quiz_info(list) {
        ...
        var user_answer = '';
        var user_ready = '';
        var user_quiz_giveup_count_display ='';
        var user_quiz_giveup_display ='';
        ...
        for (var index in list) {
            ...
            user_quiz_giveup_count_display = list[index].quiz_give_count_left;
            if(parseInt(user_quiz_giveup_count_display) <= 0){
                user_quiz_giveup_display ='<span style="color:red;">불가</span>';
                $("#GIVEUP_BTN").hide();
            }else{
                user_quiz_giveup_display ='<span style="color:blue;">가능</span>';
                $("#GIVEUP_BTN").show();
            }
           
            
        }
        $("#user_quiz_giveup_count_display").html(user_quiz_giveup_count_display);
        $("#user_quiz_giveup_display").html(user_quiz_giveup_display);
